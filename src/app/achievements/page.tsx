...
import { EducationAchievements } from '@/components/portfolio/education-achievements';
      ...
      <main className="relative z-10 pt-28 pb-16">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-8">
          ...
          <div className="flex items-center gap-2.5 text-xs font-mono text-[#736E67] mb-4">
            ...
            <span>/</span>
            <span className="text-[#1A1817] font-semibold">04 HONORS &amp; ACADEMICS</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-[#E6E2DA]">
            ...
            <p className="font-mono text-xs sm:text-sm text-[#4A4642] max-w-md">
              Manoj Kohli Scholarship recipient, TCS Delivery Excellence recognition, DaveAI Top Performer award, RTU 9.11 CGPA Honours, and peer-reviewed AI research.
            </p>
          </div>
        </div>

        {/* Education, Honors & Research Publications */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-16 pt-8 border-t border-[#E6E2DA] flex items-center justify-between font-mono text-xs">
          ...
          >
            <span>&larr;</span>
            <span>PREVIOUS: CAPABILITIES</span>
          </Link>
          <Link
            ...
            data-cursor="interactive"
          >
            <span>NEXT: LEADERSHIP &amp; IMPACT</span>
            <span>&rarr;</span>
          </Link>
        </div>
      </main>
