...
import { ExperienceStory } from '@/components/portfolio/experience-story';
      ...
      <main className="relative z-10 pt-28 pb-16">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-8">
          ...
          <div className="flex items-center gap-2.5 text-xs font-mono text-[#736E67] mb-4">
            ...
            <span>/</span>
            <span className="text-[#1A1817] font-semibold">02 EXPERIENCE</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-[#E6E2DA]">
            ...
            <p className="font-mono text-xs sm:text-sm text-[#4A4642] max-w-md">
              From hands-on software engineering at ConsultAdd and business analysis at TCS Invest India to enterprise AI product consulting at DaveAI.
            </p>
          </div>
        </div>

        {/* 4-Year Experience Timeline & Progression */}
        <ExperienceStory />
